...
public class BestRouteHelper {
    ...
    private static double calculateTravelTime(double distanceKm) {
        double timeHours = distanceKm / AVG_SPEED_KMH;
        return timeHours * 60; // Convert hours to minutes
    }

    private static double calculateDeliveryTime(DeliveryExecutive executive, Restaurant restaurant, GeoLocation customerLocation) {
    ...
    public static List<Restaurant> findOptimalRoute(DeliveryExecutive executive, List<Restaurant> restaurants, List<Customer> customers) {
